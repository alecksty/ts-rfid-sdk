...
public class BleDeviceActivity extends AppCompatActivity implements AdapterView.OnItemClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rfidApp.portManager.setType(EPortType.PORT_TYPE_BLE);
        rfidApp.portManager.setPortEvent(this);
        PortBase port = rfidApp.portManager.getPort();
        rfidApp.rfidManager.setPort(port);
    ...
    protected void onStop() {
        ...
        ManagerBLE bleManager = rfidApp.portManager.getBleManager();
