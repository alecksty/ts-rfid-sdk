                    ...
                    Dispatcher.BeginInvoke(new Action(delegate
                        {
                            ...
                            //  标签数量
                            labTagTotal.Content = "标签数:" + man.GetList().Count;
                            //  移动数量
                            labMovTotal.Content = "移动数:" + man.GetBreakTagCount();
                        }));
...
#region "消息处理"
        ...
        private void BtnCheckExport_Click(object sender, RoutedEventArgs e)
        {
            ...
            dlg.FileName = "F#" + date.Year + "-" + date.Month + "-" + date.Day + " " + date.Hour + "#" + date.Minute + "#" + date.Second + ".tagwav";
